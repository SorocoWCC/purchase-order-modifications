(function() {
    ...
    var body, srcModel, viewWatcher;
    window.SOROCOModel = {
        _modulesInstances: [], _odooM: {}, 
        ...
        _modelWatcher: function(scope) {
            console.log('[MODEL] Waiting for Odoo model to load');
            ...
            markupWatcher = window.setInterval(function() {
                ...
                if (srcModel._modulesInstances.length > 0) {
                    jQuery.each(srcModel._modulesInstances, function(index, module) {
                        ...
                        moduleCustomCont = jQuery(module.container);
        ...
        moduleContainer : {},
        scope: {},
        initModule: function(module, moduleContainer, viewWat) {
            let viewWatcherInit = (viewWat === true) ? true : false;
            this._modulesInstances.push({instance: module, container: moduleContainer, inited: false, viewWatcher: viewWatcherInit});
        },
        init: function(scope) {
            srcModel = this;
